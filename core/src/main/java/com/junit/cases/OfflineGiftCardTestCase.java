 ...
 *
 */
public class OfflineGiftCardTestCase {
	...
	public static void setUpBeforeClass() throws Exception {
	    ...
	    Thread.sleep(10000);
	    ld = new LoadData();
	    ld.loadXml(new File("./cfg/LoadData_GIFT.xml"));
	...
	public void CashWithdrawReversal() {
		processRequestReversal("00", 1, 4);
	}
	
	@Test
	public void PurchaseReversal() {
		processRequestReversal("00", 2, 5);
	}
	
	@Test
	public void BillPaymentReversal() {
		processRequestReversal("00", 3, 6);
	}
