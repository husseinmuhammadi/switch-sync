 ...
 *
 */
public class OfflineBONCardTestCase {
	...
	public static void setUpBeforeClass() throws Exception {
	    ...
	    Thread.sleep(10000);
	    ld = new LoadData();
	    ld.loadXml(new File("./cfg/LoadData_BON.xml"));
	...
	@Test
	public void CustomerInquiryDebitCardtoBON() {
		processRequest("00", 4);
	}
	
	@Test
	public void FundTransferDebitCardtoBON() {
		processRequest("00", 5);
	}

	@Test
	public void CustomerInquiryBONtoBON() {
		processRequest("00", 6);
	}

	@Test
	public void FundTransferBONtoBON() {
		processRequest("40", 7);
	}

	@Test
	public void CustomerOtherCardtoBON() {
		processRequest("00", 8);
	}

	@Test
	public void FundTransferOtherCardtoBON() {
		processRequest("00", 9);
	}

	@Test
	public void FundTransferBONtoOther() {
		processRequest("40", 10);
	}

	@Test
	public void FundTransferBONtoDebit() {
		processRequest("40", 11);
	}

	@Test
	public void CashWithdrawReversal() {
		processRequestReversal("00", 1, 12);
	}
	
	@Test
	public void PurchaseReversal() {
		processRequestReversal("00", 2, 13);
	}
	
	@Test
	public void BillPaymentReversal() {
		processRequestReversal("00", 3, 14);
	}
	
	@Test
	public void FundTransferDebitCardtoBONReversal() {
		processRequestReversal("00", 5, 15);
	}
	
	@Test
	public void FundTransferOtherToBONReversal() {
		processRequestReversal("00", 9, 16);
	}
