package com.dpi.financial.ftcom.web.controller.base.simulator.iso.packager;

import com.dpi.financial.ftcom.web.controller.base.simulator.base.IFB_BITMAP63;
import org.jpos.iso.*;
 ...
 * @version $Id: Base1Packager.java,v 1.1.1.1 2013/08/02 21:26:48 bhalchandra Exp $
 * @see ISOPackager
 * @see ISOBasePackager
 * @see ISOComponent
 */
...
/*063*/ new ISOMsgFieldPackager(
        new IFB_LLHBINARY (255, "Field 63"),
        new F63Packager()),
...
/*128*/ new IFB_BINARY  (  8, "MAC 2")
    ...
    protected class F63Packager extends Base1SubFieldPackager
    {
        ...
        {
            new IFB_BITMAP63(3, "Bit Map"),
            new IFB_NUMERIC  (4, "Network ID",true),
            new IFB_NUMERIC  (4, "Not Applicable",true),
            new IFB_NUMERIC  (4, "Message Reason Code",true),
            new IFB_NUMERIC  (4, "STIP/Switch Reason Code",true),
            new IFB_NUMERIC  (6, "Not Applicable",true),
            new IFE_CHAR     (7, "Charge Back Reduction/BaseII flags"),
            new IFB_BINARY   (64,"Network Participation Flags"),
            new IFB_NUMERIC  (8, "Visa Acquirers Business Id",true),
            new IFE_CHAR     (3, "Fraud Data"),
            new IFE_CHAR     (2, "Not Applicable"),
            new IFE_CHAR     (1, "Reimbursement Attribute"),
            new IFE_CHAR     (14,"Sharing Group Code"),
            new IFB_NUMERIC  (6, "Decimal Position Indicator",true),
            new IFE_CHAR     (36,"Issuer Currency Conversion Data"),
            new IFE_CHAR     (9, "Settlement Date, Acquirer Currency Conversion Fee Allocation"),
            new IFB_NUMERIC  (3, "ImageExpressWorkStation,Station bin Address",true),
            new IFB_NUMERIC  (1, "Additional Data Indicator",true),
            new IFB_NUMERIC  (1, "Volume Tier Request Indicator",true),
            //new IFE_CHAR   (3,  "Fee Program Indicator"),
        };
